...
from comaze.agents import AbstractAgent, SimpleOnPolicyRLAgent, SimpleCommunicatingSecretRuleOnPolicyRLAgent
...
def test_dict_obs_discrete_action_secret_rule_exp_utils():
  use_cuda = False 
  sparse_reward = False
  ...
  agent2 = SimpleCommunicatingSecretRuleOnPolicyRLAgent( 
    learning_rate=1e-4,
    discount_factor=0.99,
...
if __name__ == "__main__":
    test_dict_obs_discrete_action_secret_rule_exp_utils()
